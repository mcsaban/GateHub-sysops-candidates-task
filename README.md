...
## [part 4]
    ...
    This is my playbook for Ansible: [[tasks.yml](https://github.com/mcsaban/GateHub-sysops-candidates-task/blob/main/tasks.yml)](https://github.com/mcsaban/GateHub-sysops-candidates-task/blob/main/tasks.yml)
